    ...
    <section className="relative min-h-[85vh]">
      ...
      <div className="fixed inset-y-0 left-0 z-[1] flex w-full flex-col items-start justify-start px-6 pt-28 text-left sm:w-[40%] sm:px-12 sm:pt-32">
        <Link
          ...
          className="group mb-8 inline-flex items-center gap-2 rounded-full bg-appleInk px-6 py-3 font-inter text-sm font-medium text-white shadow-lg shadow-black/10 transition hover:bg-black active:scale-[0.98]"
        >
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 left-0 z-[1] flex w-full items-end justify-start sm:w-[40%]">
        <div className="aspect-[2/3] h-auto w-[min(65%,320px)] max-h-[56vh]">
