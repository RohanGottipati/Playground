...
export function buildLaundrylineSpec(
  ...
  return {
    ...
    rules: {
      ...
      howToPlay: [
        `${titleCase(ammo)}s fly in slow, lazy volleys — jump the low ones; they fly straight through cover blocks.`,
        "Five wide covers line the route and give you plenty to climb on.",
      ...
      tip: "The volleys are slow — time your jumps and you will never be caught in the open.",
    },
    world: baseWorld(),
    player: basePlayer(),
    entities,
