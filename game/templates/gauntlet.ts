...
export function buildGauntletSpec(
  ...
  return {
    ...
    rules: {
      ...
      howToPlay: [
        `Low ${ammo}s skim the floor — jump over them; they fly straight through cover blocks and anything else in the way.`,
        `High ${ammo}s pass at head height — stay grounded and let them fly over you.`,
        "Cover blocks are just terrain here — climb on them, but don't count on them to stop a shot.",
