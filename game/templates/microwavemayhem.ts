  ...
  return {
    ...
    rules: {
      ...
      howToPlay: [
        ...
        "Only three covers, all narrow. Sharp cutlery litters the floor between them.",
        "Jump the low shots, duck the high ones, and never linger in the open.",
        "Touching the machine hurts. The flag is planted just in front of it.",
      ],
      controls: BASE_CONTROLS,
      tip: "The stretch after the second cover is the killer — wait out a full volley before you sprint it.",
    },
    world: baseWorld(),
    player: basePlayer(),
    entities,
