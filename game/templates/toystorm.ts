  ...
  return {
    ...
    rules: {
      ...
      howToPlay: [
        ...
        "One tiny shelter — barely wider than you — is the only true cover.",
      ...
      tip: "Do not camp: drops cluster wherever you linger. Weave in wide arcs and use the shelter only to reset.",
    },
    world: baseWorld(),
    player: basePlayer(),
    entities,
